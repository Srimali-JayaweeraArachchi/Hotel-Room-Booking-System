import { findUserById, findUsers, updateUserRole } from '../repositories/userRepository.js';
...
export async function changeManagedUserRole(id, role) {
  ...
  if (user.role === 'admin') throw new AppError(403, 'Administrator roles cannot be changed here');
